...
void UACFEffectsManagerComponent::PlayCurrentActionEffect(const FActionEffect& effect)
{
    ...
    if (damageComp) {
        ...
        UE_LOG(ACFLog, Error, TEXT("No Damage Handler comp in your character!"));
    }
}
...
float UACFEffectsManagerComponent::GetNoiseToEmitForCurrentLocomotionState() const
{
    ...
    UE_LOG(ACFLog, Error, TEXT("Missing Locomotion Component! - UACFEffectsManagerComponent::GetNoiseToEmitForCurrentLocomotionState "));
    return 0.f;
}
