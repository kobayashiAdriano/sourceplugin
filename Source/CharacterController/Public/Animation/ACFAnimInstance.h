...
public:
    ...
    /*Returns true if this actor has a target in his Controller's 
    ATSBaseTargeting component, false otherwise*/
//     UFUNCTION(BlueprintPure, Category = ACF)
//     bool GetCurrentTargetLocation(FVector& outLocation) const;
    ...
    void SetRootTrans(FTransform val) { RootTrans = val; }
    // END IK
